    ...
    <Stack>
      ...
      >
        ...
        >
          ...
          winning probabilities across different scenarios, and gain insights
          into their strengths and weaknesses. Whether they’re playing at home,
          away, or on a neutral field, discover the impactful role of machine
          learning on men’s basketball.
        </Text>
        <Stack
          horizontal
          wrap
        ...
        >
          ...
          >
            ...
            <Text>
              Get started with your first prediction! Choose your teams, the
              type of game site, and model here.
            </Text>
            <Stack horizontal>
              <PrimaryButton
          ...
          >
            ...
            <Text>
              ...
              cozy confines of a college apartment. Born at UConn, renowned as
              the basketball capital of the world, this initiative emerged when
              a computer science and engineering student fused his machine
              learning knowledge with an unwavering passion for college
              basketball.
            </Text>
          </Stack>
          <Stack
