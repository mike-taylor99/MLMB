...
export function PredictPage() {
  ...
  const { data: teamsData, isLoading: teamsLoading } = useTeams({ sport, limit: 500 })
  ...
  const canSubmit = homeTeam && awayTeam && homeTeam !== awayTeam && !mutation.isPending && !isDuplicate
